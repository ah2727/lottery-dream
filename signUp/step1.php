                ...
                <div class="relative flex flex-col w-full md:w-125 lg:w-full items-stretch bg-white md:shadow lg:shadow md:rounded-2xl pt-8 md:pt-0">
                    <div class="flex flex-col px-6 lg:pt-6 md:pt-6 lg:px-22 md:px-11">
                        ...
                        <div class="lg:w-92 flex flex-col items-stretch self-center w-full">
                                ...
                                <div class="flex">
                                    <div class="w-13 justify-center cursor-default" role="button" tabindex="0">
                                        ...
                                        <div class="h-10 w-10 text-center flex items-center justify-center rounded-full m-auto animate-pop bg-blue-900">
                                            <span class="text-2xl font-bold  text-white">1 </span></div>
                                ...
                                <div class="flex">
                                    <div class="w-13 justify-center cursor-default" role="button" tabindex="0">
                                        <div class="h-10 w-10 text-center flex items-center justify-center rounded-full m-auto bg-gray-300">
                                            <span class="text-2xl font-bold  text-gray-400">2 </span></div>
                                        <div class="flex justify-center"><p
                            ...
                            <div class="px-4">
                                ...
                                <div class="mb-4">
                                    <div role="presentation"
                                        ...
                                        <div class=" flex-1"><input tabindex="0" id="Email"
                                                                    type="email" required
                                                                    autocomplete="current-password"
                                                                    class="font-bold text-lg text-blue-800 outline-none w-full"
                                                                    value="" style="height: 100%" placeholder="Email" name="email"></div>
                                    </div>
                                </div>
                                <div class="mb-6">
                                    <div role="presentation"
                                         class="relative-stacking rounded transition-colors bg-white cursor-text border pointer-events-auto px-4 py-2 h-14 flex flex-row text-left border-gray-400">
                                        <div class=" flex-1"><input tabindex="0" name="password" id="password" onkeyup="minPassword()"
                                                                    type="password" required
                                                                    autocomplete="current-password"
                                                                    class="font-bold text-lg text-blue-800 outline-none w-full"
                                                                    value="" style="height: 100%" placeholder="PASSWORD"></div>
                                    </div>
                                    <div class="pt-2 mb-1 h-4 flex items-center text-gray-600">
                                        <span class="text-sm pl-2 " style="font-size: 12px" id="minPw">MINIMUM PASSWORD LENGTH 8 CHARACTERS</span></div>
                                <hr>
                                <div class="flex justify-between my-3"><h5 class="font-bold text-xl">Security
                                        Questions</h5>
                                    <div class="flex self-center max-w-xs relative flex-row justify-between">
                                        <div role="button" tabindex="0" aria-label="Info about security questions"
                                             class="mr-3">
                                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                      d="M9 18C13.9706 18 18 13.9706 18 9C18 4.02944 13.9706 0 9 0C4.02944 0 0 4.02944 0 9C0 13.9706 4.02944 18 9 18ZM8 9C8 8.44772 8.44771 8 9 8C9.55229 8 10 8.44772 10 9V13C10 13.5523 9.55229 14 9 14C8.44771 14 8 13.5523 8 13V9ZM9 4.25C8.30964 4.25 7.75 4.80964 7.75 5.5C7.75 6.19036 8.30964 6.75 9 6.75C9.69036 6.75 10.25 6.19036 10.25 5.5C10.25 4.80964 9.69036 4.25 9 4.25Z"
                                                      fill="#2D4550"></path>
                                            </svg>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-4">
                                    <div role="presentation"
                                         class="relative-stacking rounded transition-colors bg-white cursor-text border pointer-events-auto px-4 py-2 h-14 flex flex-row text-left border-gray-400">
                                        <div class=" flex-1"><input tabindex="0" id=""
                                                                    name="mother" required
                                                                    type="text"
                                                                    autocomplete="current-password"
                                                                    class="font-bold text-lg text-blue-800 outline-none w-full"
                                                                    value="" style="height: 100%" placeholder="Your mother's maiden name"></div>
                                    </div>
                                </div>
                                <div class="mb-6">
                                    <div role="presentation"
                                         class="relative-stacking rounded transition-colors bg-white cursor-text border pointer-events-auto px-4 py-2 h-14 flex flex-row text-left border-gray-400">
                                        <div class=" flex-1"><input tabindex="0" id="" name="place"
                                                                    type="text" required
                                                                    autocomplete="current-password"
                                                                    class="font-bold text-lg text-blue-800 outline-none w-full"
                                                                    value="" style="height: 100%" placeholder="Your place of birth"></div>
                                    </div>
                                </div>
                            ...
                            <div class="flex inline-block text-blue-dark justify-center mt-6 mb-12"><p class="mr-2">Need
                                    help?</p><span class="underline d-flex align-items-center"><a href="../contact-us.php">Contact us</a></span>
                            </div>
                        </div>
                    </div>
                </div>
...
if (isset($_POST['submit'])){
    ...
    if (empty($_SESSION['email']) || empty($_SESSION['password']) || empty($_SESSION['mother']) || empty($_SESSION['place']) ){
