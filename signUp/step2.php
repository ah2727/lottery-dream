                        ...
                        <div class="flex flex-col px-6 lg:pt-6 md:pt-6 lg:px-22 md:px-11">
                            ...
                            <div class="lg:w-92 flex flex-col items-stretch self-center w-full">
                                <div class="p-5 pb-7 flex justify-center">
                                    ...
                                    <div class="flex">
                                        <div class="w-13 justify-center cursor-default" role="button" tabindex="0">
                                            ...
                                            <div class="h-10 w-10 text-center flex items-center justify-center rounded-full m-auto animate-pop bg-blue-900">
                                                <span class="text-2xl font-bold  text-white">2 </span></div>
                                            <div class="flex justify-center"><p
                                                        class="text-center leading-none font-bold uppercase pt-2 text-sm  text-blue-900">
                                                    User Details</p></div>
                                        </div>
                                    ...
                                    <div class="flex">
                                        <div class="w-13 justify-center cursor-default" role="button" tabindex="0">
                                            <div class="h-10 w-10 text-center flex items-center justify-center rounded-full m-auto bg-gray-300">
                                                <span class="text-2xl font-bold  text-gray-400">3 </span></div>
                                            <div class="flex justify-center"><p
                                                        class="text-center leading-none font-bold uppercase pt-2 text-sm  text-blue-900 text-gray-400">
                                ...
                                <div class="mb-8">
                                    <form action="" method="post">
                                        <div class=""><p class="text-sm text-gray-600 mb-2">Please ensure your details are
                                            correct before completing registration. </p>
                                        <div class="mb-4">
                                            <div role="presentation"
                                                ...
                                                <div class="flex-1"><input tabindex="0" id="" required
                                                                           name="FirstName"
                                                                           type="text"
                                                                           autocomplete="current-password"
                                                                           class="font-bold text-lg text-blue-800 outline-none w-full"
                                                                           value="" style="height: 100%" placeholder="First Name"></div>
                                            </div>
                                        </div>
                                        <div class="mb-6">
                                            <div role="presentation"
                                                ...
                                                <div class="flex-1"><input tabindex="0" id="" required
                                                                           ...
                                                                           autocomplete="current-password"
                                                                           class="font-bold text-lg text-blue-800 outline-none w-full"
                                                                           value="" style="height: 100%" placeholder="Last Name"></div>
                                            </div>
                                        </div>
                                        <span class="font-bold">Date of birth</span>
                                        <div class="flex flex-row mt-2">
                                            <div class="w-14 mr-1 sm:mr-2">
                                                <div role="presentation"
                                                     class="relative-stacking rounded transition-colors bg-white cursor-text border pointer-events-auto py-2 h-14 flex flex-row text-left border-gray-400">
                                                    <div class="flex-1"><input tabindex="0" id="" required
                                                                               name="Day"
                                                                               type="text"
                                                                               autocomplete="current-password"
                                                                               class="font-bold text-lg text-blue-800 outline-none w-full text-center"
                                                                               value="" style="height: 100%" placeholder="DD"></div>
                                                </div>
                                            </div>
                                            <div class="w-14 mr-1 sm:mr-2">
                                                <div role="presentation"
                                                     class="align-items-center relative-stacking rounded transition-colors bg-white cursor-text border pointer-events-auto py-2 h-14 flex flex-row text-left border-gray-400">
                                                    <div class="flex-1"><input tabindex="0" id="dob_month" required
                                                                               name="Month"
                                                                               type="text"
                                                                               class="font-bold text-lg text-blue-800 outline-none w-full text-center"
                                                                               value="" placeholder="MM"></div>
                                                </div>
                                            </div>
                                            <div class="w-20">
                                                <div role="presentation"
                                                     class="align-items-center relative-stacking rounded transition-colors bg-white cursor-text border pointer-events-auto  py-2 h-14 flex flex-row text-left border-gray-400">
                                                    <div class=" flex-1"><input tabindex="0" id="dob_year" required
                                                                                name="years"
                                                                                type="text"
                                                                                class="font-bold text-lg text-blue-800 outline-none w-full text-center"
                                                                                value="" placeholder="YYYY"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-6"><span class="mt-6 font-bold">Gender</span>
                                            <div class="mt-3 md:mb-11">
                                                <div class="flex flex-row space-x-4 text-base">
                                                    <div class="flex items-center cursor-pointer">
                                                        <input type="radio" name="Gender" required value="Male">
                                                        <label for="MALE" class="pl-2 cursor-pointer text-blue">Male</label>
                                                    </div>
                                                    <div class="flex items-center cursor-pointer">
                                                        <input type="radio" name="Gender" required value="Female">
                                                        <label for="FEMALE"
                                                               class="pl-2 cursor-pointer text-blue">Female</label></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        <div class="flex flex-col w-72 mt-16 mx-auto">
                                            <input type="submit" value="Continue" name="submit_step2"
...
if (isset($_POST['submit_step2'])){
    ...
    $_SESSION['birthDay'] = $_POST['years'] . '-' . $_POST['Month'] . '-' . $_POST['Day'];
    $_SESSION['Gender'] = $_POST['Gender'];
    if (empty($_SESSION['FirstName']) || empty($_SESSION['LastName']) || empty($_SESSION['birthDay']) || empty($_SESSION['Gender'])){
        echo "Hello world11";
        $errorMsg = "Filedf Can not empty";
    }else{
